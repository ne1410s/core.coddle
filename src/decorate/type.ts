...
export abstract class Type {
  public static readonly boolean: TypedPropertyDecorator<
  ...
  public static readonly date: TypedPropertyDecorator<Date | string | Array<Date | string>> = (
    trg,
    key
  ) => {
    Reflect.defineMetadata(`${ValidationKey.TYPE}:${key.toString()}`, key, trg);
  ...
  public static readonly integer: TypedPropertyDecorator<number | string | Array<number | string>> =
    (trg, key) => {
      Reflect.defineMetadata(`${ValidationKey.TYPE}:${key.toString()}`, key, trg);
      Reflect.defineMetadata(ValidationKey.TYPE, 'integer', trg, key);
    };

  public static readonly number: TypedPropertyDecorator<number | string | Array<number | string>> =
    (trg, key) => {
      Reflect.defineMetadata(`${ValidationKey.TYPE}:${key.toString()}`, key, trg);
